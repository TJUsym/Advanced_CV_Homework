...
model = dict(
    type='FasterRCNNOBB',
    pretrained='senet_Pretarin/se_resnet50-ce0d4300.pth',
    backbone=dict(
        type='SENet',
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'DroneVehicle/train/trainimg',
        img_scale=(1333, 800),
    ...
    test=dict(
        ...
        img_prefix=data_root + 'DroneVehicle/test/testimg',
        img_scale=(1333, 800),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_obb_senet'
load_from = None
resume_from = None
workflow = [('train', 1)]
