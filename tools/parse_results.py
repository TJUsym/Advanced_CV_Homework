...
if __name__ == '__main__':
    ...
    print(config_name)
    pkl_file = os.path.join('/root/door/Advanced_CV_Homework/DroneVehicle', config_name, 'results.pkl')
    output_path = os.path.join('/root/door/Advanced_CV_Homework/DroneVehicle', config_name)
    type = args.type
